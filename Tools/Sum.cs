...
namespace HRM.Tools
{
    ...
    public static class Sum
    {
        ...
        public static string GetTextEn(int number)
        {
            if (number == 0)
                return "zero";

            if (number < 0)
                return "minus " + GetTextEn(Math.Abs(number));

            string words = "";

            if ((number / 1000000) > 0)
            {
                words += GetTextEn(number / 1000000) + " million ";
                number %= 1000000;
            }

            if ((number / 1000) > 0)
            {
                words += GetTextEn(number / 1000) + " thousand ";
                number %= 1000;
            }

            if ((number / 100) > 0)
            {
                words += GetTextEn(number / 100) + " hundred ";
                number %= 100;
            }
        ...
        public static  string GetTextRu(decimal sum){
            StringBuilder sumText = new StringBuilder() { };

            decimal целая = Math.Floor((decimal)sum);
            HRM.Tools.Число.Пропись(целая, HRM.Tools.Валюта.БезВалюты.ОсновнаяЕдиница, sumText);

            return sumText.ToString();
        }

        public static string GetTextKz(decimal sum)
        {
            StringBuilder sumText = new StringBuilder() { };
            ...
            word.Add("две", "екі");
            word.Add("три", "үш");
            word.Add("четыре", "төрт");
            word.Add("пять", "бес");
            word.Add("шесть", "алты");
            word.Add("семь", "жеті");
            word.Add("восемь", "сегіз");
            word.Add("девять", "тоғыз");
            word.Add("двадцать", "жиырма");
            word.Add("тридцать", "отыз");
            word.Add("сорок", "қырық");
            word.Add("пятьдесят", "елу");
            word.Add("шестьдесят", "алпыс");
            word.Add("семьдесят", "жетпіс");
            word.Add("восемьдесят", "сексен");
            word.Add("девяносто", "тоқсан");
            word.Add("сто", "жүз");
            word.Add("двести", "екі жүз");
            word.Add("триста", "үш жүз");
            word.Add("четыреста", "төрт жүз");
            word.Add("пятьсот", "бес жүз");
            word.Add("шестьсот", "алты жүз");
            word.Add("семьсот", "жеті жүз");
            word.Add("восемьсот", "сегіз жүз");
            word.Add("девятьсот", "тоғыз жүз");
            word.Add("тысяча", "мың");
            word.Add("тысячи", "мың");
            word.Add("тысяч", "мың");
            word.Add("миллион", "миллион");
            word.Add("миллиард", "миллиард");
            word.Add("триллион", "триллион");
            word.Add("квадриллион", "квадриллион");
            word.Add("квинтиллион", "квинтиллион");
            word.Add("секстиллион", "секстиллион");
            word.Add("септиллион", "септиллион");
            word.Add("октиллион", "октиллион");
            word.Add("десять", "он");
            word.Add("одиннадцать", "он бір");
            word.Add("двенадцать", "он екі");
            word.Add("тринадцать", "он үш");
            word.Add("четырнадцать", "он төрт");
            word.Add("пятнадцать", "он бес");
            word.Add("шестнадцать", "он алты");
            word.Add("семнадцать", "он жеті");
            word.Add("восемнадцать", "он сегіз");
            word.Add("девятнадцать", "он тоғыз");

            string sumTextKz = sumText.ToString();
            foreach (var item in word)
                sumTextKz = HRM.Models.DocTools.ReplaceWholeWord(sumTextKz, item.Key, item.Value);
            return sumTextKz;
        }
    }
        ...
        public class Валюта
        {
            ...
            public static readonly Валюта БезВалюты = new Валюта(
